#!/usr/bin/env python3
"""
fsm_node.py — runs on the ROBOT (Pi)

UNCHANGED except this comment: it now subscribes to aruco/target/*,
aruco/trailer/* from camera_node.py instead of the old detector_node.py.
Topic names/contract are identical, so no logic changes were required.

Steuerungslogik: aruco_fsm.py (Original, unverändert)
"""
